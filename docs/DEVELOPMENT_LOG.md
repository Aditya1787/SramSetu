...
- **[2026-09-01 12:03]**: feat(workflow): add customer authorization prompt for price adjustments
- **[2026-09-01 12:53]**: feat(payments): integrate Razorpay payment intent initialization
- **[2026-09-01 16:05]**: feat(payments): add Cash on Delivery (COD) settlement workflow
...
- **[2026-09-02 20:32]**: feat(admin): create master price editor for materials and labor rates
- **[2026-09-02 21:08]**: perf(db): add spatial indexes for technician geolocation queries
- **[2026-09-02 21:30]**: perf(cache): implement in-memory cache for static service catalogs
- **[2026-09-02 21:43]**: fix(auth): resolve session token expiration edge case
- **[2026-09-03 10:13]**: fix(pricing): correct GST rounding precision on multi-item service orders
- **[2026-09-03 14:36]**: fix(geo): add fallback coordinate resolution when GPS is unavailable
...
- **[2026-09-06 20:28]**: feat(customer): implement saved address manager (Home, Office, Other)
- **[2026-09-07 12:44]**: refactor: clean up deprecated API routes and update error handlers
...
- **[2026-09-08 09:24]**: docs: initialize system architecture outline and milestone plan
- **[2026-09-08 10:29]**: feat(auth): initialize Supabase authentication client setup
- **[2026-09-08 14:38]**: feat(auth): implement phone OTP verification service
- **[2026-09-08 17:03]**: feat(auth): add role-based authorization rules (customer, technician, admin)
- **[2026-09-08 22:04]**: feat(db): create initial schema for user profiles and contact info
- **[2026-09-09 11:30]**: feat(db): add migrations for technician trust badges and certifications
- **[2026-09-09 13:46]**: feat(catalog): define service categories: electrical, plumbing, carpentry
- **[2026-09-09 15:12]**: feat(catalog): add sub-service definitions and standard problem lists
- **[2026-09-09 17:53]**: feat(pricing): implement upfront quotation calculation algorithm
- **[2026-09-10 14:24]**: feat(pricing): add material pricing lookup matrix with regional modifiers
- **[2026-09-10 16:43]**: feat(pricing): introduce transparent visit charge and platform fee breakdown
...
- **[2026-09-11 11:32]**: feat(customer): build photo/video upload preview for repair inspection
...
- **[2026-09-12 20:58]**: feat(technician): build incoming job lead alert modal
- **[2026-09-12 21:29]**: feat(technician): implement lead accept and decline action handlers
- **[2026-09-13 10:07]**: feat(technician): build technician active job timeline (En Route -> Arrived)
...
- **[2026-09-14 18:39]**: feat(feedback): add post-service rating and review submission
- **[2026-09-14 21:17]**: feat(trust): implement technician background verification badge widget
- **[2026-09-14 21:54]**: feat(admin): build admin dispute resolution audit log
- **[2026-09-15 09:51]**: feat(admin): create master price editor for materials and labor rates
...
- **[2026-09-17 18:48]**: docs: update API documentation and endpoint schemas
- **[2026-09-17 20:37]**: feat(notifications): add SMS alert gateway integration for booking updates
